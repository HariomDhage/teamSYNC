        ...
        <div className={`${mobile ? 'fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-xl' : 'hidden md:flex w-64 bg-white border-r border-gray-200'} flex-col h-full`}>
            ...
            <div className="p-4 border-t border-gray-200">
                ...
                <button
                    ...
                    className="w-full text-sm text-gray-700 hover:text-gray-900 px-3 py-2 rounded-lg hover:bg-gray-50 flex items-center gap-2 transition-all mb-2"
                >
                ...
                {mobile && onClose && (
                    <button
                        onClick={onClose}
                        className="w-full text-sm text-red-600 hover:text-red-700 hover:bg-red-50 px-3 py-2 rounded-lg flex items-center justify-center gap-2 transition-all border border-red-200"
                    >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                        </svg>
